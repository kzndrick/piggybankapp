...
namespace PiggybankApp
{
    public partial class PiggybankForm : Form
    {
        ...
        private void calculateButton_Click(object sender, EventArgs e)
        {
            ...
            totalAmount.Text = $"Total Amount: ₱{totalAmountValue:N2}";
        }
        ...
        private void gcashButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"Successfully sent to GCash: ₱{totalAmountValue:N2}", "GCash Transfer", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ClearButtonTexts();
        }
